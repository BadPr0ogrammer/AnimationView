...
class SimpleParaViewCustomFiltersPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/SimpleParaViewCustomFiltersPlugin")
#endif
public:
  SimpleParaViewCustomFiltersPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "SimpleParaViewCustomFilters"; }
  ...
  const char* GetDescription() override
    { return "An example paraview plugin to be loaded in SimpleParaview Copied from ElevationFilters example"; }
