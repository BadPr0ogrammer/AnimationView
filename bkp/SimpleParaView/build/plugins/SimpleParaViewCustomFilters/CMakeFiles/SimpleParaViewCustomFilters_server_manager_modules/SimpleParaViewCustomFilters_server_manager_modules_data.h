...
//
#ifndef SimpleParaViewCustomFilters_server_manager_modules_data_h
#define SimpleParaViewCustomFilters_server_manager_modules_data_h
...
// From file /home/mikeuser/VtuAnimationView/SimpleParaView/plugins/SimpleParaViewCustomFilters/ElevationFilters/MyElevationFilter.xml
static const char* const SimpleParaViewCustomFilters_server_manager_modulesMyElevationFilterInterface0 =
...
"\n";
// Get single string
inline char* SimpleParaViewCustomFilters_server_manager_modulesMyElevationFilterGetInterfaces()
{

  const size_t len0 = strlen(SimpleParaViewCustomFilters_server_manager_modulesMyElevationFilterInterface0);
  size_t len = ( 0
    + len0 );
  char* res = new char[ len + 1];
  size_t offset = 0;
  std::copy(SimpleParaViewCustomFilters_server_manager_modulesMyElevationFilterInterface0, SimpleParaViewCustomFilters_server_manager_modulesMyElevationFilterInterface0 + len0, res + offset); offset += len0;
  assert(offset == len);
  res[offset] = 0;
  return res;
}
